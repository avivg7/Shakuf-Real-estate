...
public class ApartmentManager {
	...
	public void runManager() {
		...
		try {
			...
			while(!_stopRunningMunu) {
				...
				String userSelection = GUI_Opetator.getUserSelection(
						options, 
				...
				switch ( userSelection ) {
					...
					case "Exit":
						...
						GUI_Opetator.showGUI_Massage("Thank you and goodbye");
						break;
		...
		try {
			...
			switch ( userSelection) {
				case "Apartment For Rent":
					...
					GUI = new GUI_Opetator(LABEL_TEXTS_RENT, "Create a new rent apartment");
				    ...
				    if ( this.isExist(_counterID + 1) ) {
				    	GUI_Opetator.showGUI_Massage("The action failed, the database is allready contain an apartment with similar ID, please try again");
				    	_counterID++;
					} 
						...
						GUI_Opetator.showGUI_Massage("Apartment added successfully");
					}			
			    break;
				case "Apartment For Sall":
					...
					// Create a new GUI with the text labels we created
					GUI = new GUI_Opetator(LABEL_TEXTS_SALL, "Create a new sale Apartment");
			...
			GUI_Opetator.showGUI_Massage("The action failed, please fill in all the fields before sending the create file");
		}					    
	}
	...
	public void showAllApartments() {
		...
		try {
			...
			*/
			...
			GUI_Opetator.showGUI_Massage("Somthing went wrong, please try again");
		}
	}
	...
	public void sortByPrice() {
		...
		GUI_Opetator.showGUI_Massage("The apartments were successfully sorted");
	}
